...
function customizer_library_vogue_options() {
    ...
    $options['vogue-disable-google-fonts'] = array(
        ...
        'type'    => 'checkbox',
        'default' => 0,
        'description' => __( 'Selecting this uses the websafe font\'s - Tahoma for Heading/Title text and Arial for Body & Inputs text.<br /><br />Turning this on will stop the font selection settings from working and also stop your website connecting to Google servers.', 'vogue' ),
    );
    ...
    $options['vogue-note-fonts-one'] = array(
        'id' => 'vogue-note-fonts-one',
        'section' => $section,
        'type'    => 'note',
        'description' => __( 'Google Fonts has been disabled. <a href="#vogue-site-layout-section" rel="tc-section">Enable them here</a>', 'vogue' ),
    );
    ...
    $options['vogue-note-social'] = array(
        ...
        'section' => $section,
        'type'    => 'note',
        'description' => __( '<b>Premium Extra Features:</b><br />- Over 22 different social profile links available<br />- Setting to add your own social icon', 'vogue' )
    );

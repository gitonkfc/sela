 ...
 * @package Vogue
 */
define( 'VOGUE_THEME_VERSION' , '1.4.22' );
...
function vogue_scripts() {
	...
	wp_enqueue_style( 'vogue-font-awesome', get_template_directory_uri().'/includes/font-awesome/css/fontawesome-all.css', array(), '5.0.13' );

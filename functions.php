...
function sela_scripts_styles() {
	...
	wp_enqueue_script( 'hyphenator', 'http://hyphenator.googlecode.com/svn/tags/Version%204.2.0/Hyphenator.js', array(), false, true );
...
function sc_homerecentpost ($atts)
{
    ...
    $out .= '<div class="col">';
    $out .= '<h4 class="title font-weight-bold">Latest Article</h4>';
    $out .= '</div>';
